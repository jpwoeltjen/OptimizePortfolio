    ...
    def threshold_sector_neutral_positions(self,
        ...
        for ind in sectors:
            ...
            if threshold is not None:
                ...
                long_pos_in_grace = [x for x in
                        list(set(long_grace).intersection(set(self.longs())))
                        if x not in long_ind]

                short_pos_in_grace = [x for x in
                        list(set(short_grace).intersection(set(self.shorts())))
                        if x not in short_ind]
